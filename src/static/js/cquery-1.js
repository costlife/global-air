...
function airportList(airportInfo, cityName, airPortCode, isFilterAirPortCode, isFilterCityName, isCity, isAirPort) {
    ...
    if (airportInfo.cityNameCn == '' || airportInfo.cityNameEn == '' || airportInfo.airportNameCn == '' || airportInfo.airportCode == '' || airportInfo.cityNameCn == 'null' || airportInfo.cityNameEn == 'null' || airportInfo.airportNameCn == 'null' || airportInfo.airportCode == 'null' || airportInfo.countryCodeCn == 'null') {
        return '';
    }
